...
exports.budgetSchema = exports.amountSchema = exports.loginSchema = exports.registerSchema = void 0;
...
exports.amountSchema = joi_1.default.number()
    .positive()
...
exports.budgetSchema = joi_1.default.object({
    name: joi_1.default.string().max(255).required().empty(""),
    warning_amount_for_db: exports.amountSchema,
    allocated_amount_for_db: exports.amountSchema,
    color: joi_1.default.string().max(255).optional().allow(""),
    icon: joi_1.default.string().optional().allow(""),
}).messages({
